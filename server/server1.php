...
<video id="player" controls preload="metadata" poster="wc.jpg" class="plyr">
<source src="https://red.anonymouscdn.cfd/live.php" type="application/x-mpegURL"/>
</video>
...
<script>      document.addEventListener('DOMContentLoaded', () => {          const player = Plyr.setup('.js-player');      });  </script>
                   ...
                   <meta charset="UTF-8">        <meta http-equiv="refresh" content="2000; url=">                          

<!-- Google tag (gtag.js) --><script async src="https://www.googletagmanager.com/gtag/js?id=G-H5DKLJLN0W"></script><script>  window.dataLayer = window.dataLayer || [];  function gtag(){dataLayer.push(arguments);}  gtag('js', new Date());  gtag('config', 'G-H5DKLJLN0W');</script>

<script type='text/javascript' src='//sparkleporedip.com/f6/e8/0a/f6e80a0e7285e901882a4b3f17852df4.js'></script></body>
</html>
